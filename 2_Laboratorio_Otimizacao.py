...
with st.sidebar:
    ...
    with st.expander("Filtros de Ativos"):
        ...
        filtro_classe = st.selectbox("Classe:", options=classes_disp, index=0)
        ...
        filtro_subclasse = st.selectbox("Subclasse:", options=subclasses_disp, index=0)
        ...
        filtro_grupo = st.selectbox("Grupo:", options=grupos_disp, index=0)
    ...
    janela = st.selectbox(
        ...
        ["6 Meses", "12 Meses", "24 Meses", "36 Meses", "Desde o Início"],
        index=2
    )
